...
Does having an Asian American candidate on the ballot increase Asian American voter turnout? Asian American history is filled with moments of political activism and solidarity among Asian Americans, yet there are various class and ideological fissures among Asian Americans as a whole today. Moreover, answering this question may enable candidates to better understand voters by knowing if Asian American identity is mobilizing factor. Another dependent variable I am interested in seeing is if the percent of Asian Americans in a district affects Asian American voter turnout to see if there is another correlation with this factor.

I hypothesize that Asian American candidates increase voter turnout among Asian Americans because Asian candidates can better mobilize Asian American voters under a shared set of interests. 
...
Here in this scatterplot plotted with a regression line, there is a positive correlation between the percent of Asian Americans in a district with total Asian American voter turnout.
...
In conclusion, I have found evidence to support my hypothesis that Asian American candidates increase Asian American voter turnout. However, since my dataset was mainly based on an observational study, I have found multiple confounders that could prevent causal interpretations between these variables. For example, there is the issue of the candidate’s ideology. My analysis has not accounted for any affinities between the ideologies of Asian American voters and Asian American candidates, so more time and resources could be used in analyzing the correlation between these factors. Another potential confounder is geography, since the dataset that was used solely focused on California districts. To expand our sample and to improve inference for the broader Asian American population in the United States, similar analysis could be conducted to majority-Asian American districts in other states.
